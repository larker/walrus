...
(function($jq){
	$jq.fn.imageEditor = function() {
		return this.each(function() {
			...
			var adder = jQuery('<form class="cmsDialog" name=\"imageEditor_' + boxId + '\" method=\"POST\" enctype=\"multipart/form-data\" action=\"editimage\" id=\"' +	formId + '\"/>');
			adder.hide();
			
			adder.append(jQuery("<h2>新图片(注意尺寸125*488)</h2>"));
